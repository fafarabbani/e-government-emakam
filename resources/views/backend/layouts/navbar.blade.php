<header class="navbar navbar-expand-md d-print-none flex flex-wrap" >
    <div class="container-xl">
      ...
      <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
        <a href=".">
          <img src="{{asset('./admnihome/img/logo-diskominfo.png')}}"  alt="Diskominfo" class="navbar-brand-image">
        </a>
      </h1>
      <div class="navbar-nav flex-row order-md-last">
        ...
        <div class="nav-item dropdown">
          <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
            {{-- <span class="avatar avatar-sm" style="background-image: url(./img/avatars/user.jpg)"></span> --}}
              @if (Auth::user()->pegawai->foto)  <img src="{{ asset('assets/img/pegawai/' . Auth::user()->pegawai->foto) }}" class="avatar avatar-sm" alt="">
              @else
                  <img src="{{ asset('assets/img/avatars/user.jpg') }}" class="avatar avatar-sm" alt="">
              @endif
            <div class="d-none d-xl-block ps-2" name="trigger">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item {{ request()->is('pegawai') ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('pegawai.index') }}" >
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-users" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/>
            ...
            <li class="nav-item {{ request()->is('jabatan*') || request()->is('lokasi-presensi*') ? 'active' : '' }} dropdown">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                <div class="dropdown-menu-columns">
                  <div class="dropdown-menu-column">
                    <a class="dropdown-item" href="{{route('dataRekapHarian')}}">
                      Rekap Harian
                    </a>
                    <a class="dropdown-item" href="{{route('dataRekapBulanan')}}">
                      Rekap Bulanan
                    </a>
                  </div>
                </div>
            ...
            <li class="nav-item {{ request()->is('ketidakhadiran') ? 'active' : '' }}">
              <a class="nav-link" href="{{route('dataKetidakhadiran')}}" >
