    ...
    <div class="container mx-auto">
        <div class="flex flex-wrap">
            <div class="w-full px-4 mb-10 lg:w-1/2">
                <h4 class="font-bold uppercase text-primary text-lg mb-3 font-poppins">Tentang Kami</h4>
                <h2 class="font-bold text-dark text-3xl mb-5 font-poppins max-w-md lg:text-4xl lg:max-w-none">Selamat datang di e-Government Makam!</h2>
                <p class="font-medium text-base text-slate-500 max-w-xl lg:text-lg">Kami berkomitmen untuk terus mengembangkan e-Government Makam demi memberikan pelayanan yang terbaik bagi masyarakat. Silahkan hubungi kami jika Anda memiliki pertanyaan atau masukan. Menjadi platform e-Government terkemuka dalam bidang pengelolaan data dan pendaftaran pemakaman di Indonesia.</p>
            </div>
            <div class="w-full px-4 lg:w-1/2">
                <h3 class="font-semibold text-dark text-2xl mb-4 font-poppins lg:text-3xl lg:pt-10">Mari Berteman</h3>
                <p class="font-medium text-base text-slate-500 mb-6 lg:text-left"> Mari bersama-sama mewujudkan pengelolaan data pemakaman yang modern dan efisien. Hubungi Kami</p>
