    ...
    <div class="container mx-auto">
        <div class="flex flex-wrap">
            <div class="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
                <h2 class="font-bold text-4xl text-white mb-5 font-poppins">E-Makam</h2>
                <h3 class="font-bold text-2xl mb-2 font-poppins">Hubungi kami</h3>
                <p>Hubungi kami</p>
                <p>Hubungi kami</p>
            </div>
            <div class="w-full px-4 mb-12 md:w-1/3">
                <h3 class="font-semibold text-xl text-white mb-5 font-poppins">Kategori Tulisan</h3>
                <ul class="text-slate-300">
                    <li>
                        <a href="" class="inline-block text-base hover:text-primary">Pemakaman</a>
                    </li>
                    <li>
                        <a href="" class="inline-block text-base hover:text-primary">TPU</a>
                    </li>
                    <li>
                        <a href="" class="inline-block text-base hover:text-primary">Makam</a>
                    </li>
                </ul>
            </div>
            <div class="w-full px-4 mb-12 md:w-1/3">
                <h3 class="font-semibold text-xl text-white mb-5 font-poppins">Tautan</h3>
                <ul class="text-slate-300">
                    <li>
                        <a href="home" class="inline-block text-base hover:text-primary">Home</a>
                    </li>
                    <li>
                        <a href="#about" class="inline-block text-base hover:text-primary">About</a>
                    </li>
                    <li>
        ...
        <div class="w-full pt-10 border-t border-slate-700">
            <div class="flex items-center justify-center mb-5">
                <!-- Youtube -->
                <a href="#" target="blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-400 hover:border-primary hover:bg-primary hover:text-white">
            ...
            <p class="font-medium text-xs text-slate-500 text-center">Dibuat dengan <span class="text-pink-500">❤</span> oleh <a href="https://instagram.com/fafarabbani" target="blank" class="font-bold font-poppins text-sky-500">Fafa Rabbani</a>, menggunakan <a href="https://tailwindcss.com" target="blank" class="font-bold font-poppins text-sky-500">Tailwind CSS</a>.</p>
        </div>
    </div>
<!-- Footer End -->